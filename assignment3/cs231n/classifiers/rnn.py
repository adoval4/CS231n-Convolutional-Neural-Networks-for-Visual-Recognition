...
class CaptioningRNN(object):
    ...
    def loss(self, features, captions):
        ...
        # (2)
        embedded_captions_in, cache_embedded_captions_in = word_embedding_forward(captions_in, W_embed)
        # (3)
        ...
        # (2)
        grads['W_embed'] = word_embedding_backward(dout, cache_embedded_captions_in) 
        # (1)
    ...
    def sample(self, features, max_length=30):
        ...
        # initial internal lstm state
        c = 0

        for i in range(max_length):
            if self.cell_type == 'lstm':
                h, c, _ = lstm_step_forward(x, h, c, Wx, Wh, b)
            else: # if self.cell_type == 'rnn':
